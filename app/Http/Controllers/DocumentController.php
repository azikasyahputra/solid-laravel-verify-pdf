...
{
    public function store(StoreDocumentRequest $request, ReadFileContent $readFileContent, 
    CheckRecipient $checkRecipient, CheckIssuer $checkIssuer, CheckIdentityProof $checkIdentityProof, 
    CheckSignature $checkSignature, StoreVerificationResult $storeVerificationResult) : DocumentVerifiedResource
    {
